                    ...
                    <form action="{{ route('ujian.update', ['id'=>$ujian->id]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="jumlah_soal" type="text" onkeypress="isInputNumber(event)" class="form-control"
                                required maxlength="11" value="{{$ujian->jumlah_soal}}">
                        </div>
                        <div class="form-group">
                            <label for="">Keterangan</label>
                            <textarea name="keterangan" cols="30" rows="4" class="form-control"
                                required>{{$ujian->keterangan}}</textarea>
                        </div>
